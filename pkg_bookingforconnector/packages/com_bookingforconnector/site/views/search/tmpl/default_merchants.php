	...
	<div class="com_bookingforconnector-search-merchants com_bookingforconnector-items <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?> com_bookingforconnector-list">
		...
		?>
				...
				<div class="com_bookingforconnector-search-merchant com_bookingforconnector-item  <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?>" >
					...
					<div class="com_bookingforconnector-item-details  <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?>" >
						...
						<div class="com_bookingforconnector-search-merchant-details com_bookingforconnector-item-primary <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>6">
							...
							<?php if ($isportal && ($merchant->RatingsContext ==1 || $merchant->RatingsContext ==3)):?>
								<div class="ratinggrid">
									...
									<div class="com_bookingforconnector-search-merchant-reviews-ratings com_bookingforconnector-item-reviews-ratings">
										...
										<a class="com_bookingforconnector-search-merchant-review-count com_bookingforconnector-item-review-count" href="<?php echo $routeRating ?>" id="ratingAnchorcount<?php echo $merchant->MerchantId?>" ><?php echo sprintf(JTEXT::_('COM_BOOKINGFORCONNECTOR_DEFAULT_RATING_BASED'),$merchant->reviewCount) ?></a>
									</div>
									<?php else: ?>
									<div class="com_bookingforconnector-search-merchant-reviews-ratings com_bookingforconnector-item-reviews-ratings">
							...
							<a class="com_bookingforconnector-search-merchant-name-anchor com_bookingforconnector-item-primary-name-anchor namegrid eectrack" href="<?php echo $routeMerchant ?>" data-type="Merchant" id="nameAnchor<?php echo $merchant->MerchantId?>" data-id="<?php echo $merchant->MerchantId?>" data-index="<?php echo $mrcKey?>" data-category="<?php echo $merchant->MrcCategoryName; ?>" data-itemname="<?php echo $merchant->Name; ?>" data-brand="<?php echo $merchant->Name; ?>"><?php echo  $merchant->Name ?></a> 
			...
			<!-- resource list -->
				...
				?>
				<?php foreach($merchant->Resources as $key => $resource) : ?>  
					<?php
...
//							$resourceName = trim(str_replace(" - ".$resource->RateplanName,"",$resourceName)); 
							...
							$resourceRoute = JRoute::_($currUriresource.'&s=1');
						...
						<div class="com_bookingforconnector-search-resource-details-name com_bookingforconnector-item-secondary-name" style="padding-left:10px;">
							<a href="<?php echo $resourceRoute?>" class="eectrack" data-id="<?php echo $resource->ResourceId?>" data-index="<?php echo $counter?>" data-type="Resource" data-category="<?php echo $merchant->MrcCategoryName; ?>" data-itemname="<?php echo  $resourceName; ?>" data-brand="<?php echo $resource->MrcName; ?>"><?php echo $resourceName; ?></a>
