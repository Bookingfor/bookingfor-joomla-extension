...
//	$resourceName = BFCHelper::getLanguage($resource->Name, $this->language);
	...
	if ($itemId<>0){
		$resourceRoute = JRoute::_($uri.'&resourceId=' . $resource->ResourceId . ':' . BFCHelper::getSlug($resourceName).'&Itemid='.$itemId );
	} else {
		$resourceRoute = JRoute::_($uri.'&resourceId=' . $resource->ResourceId . ':' . BFCHelper::getSlug($resourceName));
	}
...
//		$uriMerchant.='&merchantId=' . $resource->MerchantId . ':' . BFCHelper::getSlug($merchant->Name);
	if ($itemIdMerchant<>0)
		$uriMerchant.='&merchantId=' . $resource->MerchantId . ':' . '&Itemid='.$itemIdMerchant;
	else
		$uriMerchant.='&merchantId=' . $resource->MerchantId . ':' ;
			...
			<div class="com_bookingforconnector-search-resource com_bookingforconnector-item <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?>">
				<div class="mrcgroup" id="bfcmerchantgroup<?php echo $result->ResourceId; ?>"><span class="bfcmerchantgroup"></span></div>
						...
						<div class="com_bookingforconnector-search-merchant-carousel com_bookingforconnector-item-carousel <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>4">
							<div id="com_bookingforconnector-search-resource-carousel<?php echo $result->ResourceId; ?>" class="carousel" data-ride="carousel"  data-interval="false">
								<div class="carousel-inner" role="listbox">
									...
									<?php if($isportal): ?>
										<a class="com_bookingforconnector-search-resource-logo com_bookingforconnector-logo-grid eectrack" href="<?php echo $routeMerchant?>" id="merchantname<?php echo $result->ResourceId?>" data-type="Merchant" data-id="<?php echo $merchant->MerchantId?>" data-index="<?php echo $mrcKey?>" data-itemname="<?php echo $merchant->Name; ?>" data-brand="<?php echo $merchant->Name; ?>" data-category="<?php echo $result->MerchantCategoryName; ?>"><div class="containerlogo"><img class="com_bookingforconnector-logo" id="com_bookingforconnector-logo-grid-<?php echo $result->ResourceId?>" src="<?php echo $merchantLogoUrl; ?>" /></div></a>
									<?php endif; ?>
					...
					<div class="com_bookingforconnector-search-merchant-details com_bookingforconnector-item-primary <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>6">
						<div class="com_bookingforconnector-search-merchant-name com_bookingforconnector-item-primary-name">
							<a class="com_bookingforconnector-search-merchant-name-anchor com_bookingforconnector-item-primary-name-anchor eectrack" href="<?php echo $resourceRoute ?>" id="nameAnchor<?php echo $result->ResourceId?>" data-id="<?php echo $result->ResourceId?>" data-index="<?php echo $mrcKey?>" data-type="Sales Resource" data-itemname="<?php echo $result->Name; ?>" data-category="<?php echo $result->MerchantCategoryName; ?>" data-brand="<?php echo $merchant->Name; ?>"><?php echo  $resourceName; ?></a>
						</div>
					...
					<?php if($isportal): ?>
						<div class="com_bookingforconnector-item-secondary-logo <?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>2">
							<a class="com_bookingforconnector-search-merchant-logo com_bookingforconnector-logo-list eectrack" href="<?php echo $routeMerchant ?>" data-type="Merchant" data-id="<?php echo $merchant->MerchantId?>" data-index="<?php echo $mrcKey?>" data-itemname="<?php echo $merchant->Name; ?>" data-category="<?php echo $result->MerchantCategoryName; ?>" data-brand="<?php echo $merchant->Name; ?>"><img class="com_bookingforconnector-logo" src="<?php echo $merchantLogoUrl; ?>" id="com_bookingforconnector-logo-list-<?php echo $result->ResourceId?>" /></a>
						</div> <!--  COL 2-->
					<?php endif; ?>
				</div>
				<div class="clearfix"></div>
				<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?> secondarysection"  style="padding-top: 10px !important;padding-bottom: 10px !important;">
					...
					<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>3 com_bookingforconnector-item-secondary-section-3 secondarysectionitem">
							<a href="<?php echo $resourceRoute ?>" class=" com_bookingforconnector-item-secondary-more eectrack" data-id="<?php echo $result->ResourceId?>" data-type="Sales Resource" data-index="<?php echo $mrcKey?>" data-itemname="<?php echo $result->Name; ?>" data-category="<?php echo $result->MerchantCategoryName; ?>" data-brand="<?php echo $merchant->Name; ?>"><?php echo JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANTS_VIEW_MERCHANTDETAILS_OFFER_DETAILS')?></a>
					</div>
				</div>
