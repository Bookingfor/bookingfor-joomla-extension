...
$merchantratings = $this->getmodel()->getItemsRating();
...
if(isset($merchantratings)){
	...
	<div class="resourcetabcontainer">
		<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?> com_bookingforconnector_rating_valuation-wrapper">
