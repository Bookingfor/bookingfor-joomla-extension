...
<div class="royalSlider rsUni" id="resourcegallery" style="display: none">
	...
	<div>
	  <a class="rsImg" href="<?php echo BFCHelper::getImageUrlResized('merchant', $image['data'],'')?>"><img class="rsTmb" src="<?php echo BFCHelper::getImageUrlResized('merchant', $image['data'],'logomedium')?>" onerror="this.onerror=null;this.src='<?php echo BFCHelper::getImageUrl('resources', $image['data'], 'logomedium')?>'" /></a>
	</div>	
	<?php  } else { ?>
	<?php
	$url='';
