...
<div class="com_bookingforconnector_resource com_bookingforconnector_resource-mt<?php echo  $merchant->MerchantTypeId?> com_bookingforconnector_resource-t<?php echo  $resource->CategoryId?>">
   <h2 class="com_bookingforconnector_resource-name"><?php echo  $resourceName?> </h2>
	<h2 class="com_bookingforconnector_merchant-name">
		<span class="com_bookingforconnector_resource-merchant-rating">
		<?php for($i = 0; $i < $resource->Merchant->Rating; $i++) { ?>
		  <i class="fa fa-star"></i>
		<?php } ?>
		</span>
		<?php echo  $resource->Merchant->Name?> 
	</h2>
	<div class="com_bookingforconnector_resource-address">
		<span class="street-address"><?php echo $addressDataMerchant->Address ?></span>, <span class="postal-code "><?php echo $addressDataMerchant->ZipCode ?></span> <span class="locality"><?php echo $addressDataMerchant->CityName ?></span> <span class="region">(<?php echo $addressDataMerchant->RegionName ?>)</span></strong>
	...
	<div class="com_bookingforconnector_onsell_feature">
		<span>
	...
	<div class="highlight-form">
		...
		<div class="borderform">
			<div class="borderformtitle">
				<h4><?php echo  JTEXT::_('COM_BOOKINGFORCONNECTOR_RESOURCE_FORM_TITLE') ?></h4>
			</div>
			<div class="borderformtitle">
<?php 
...
?>
				<?php if ($isMerchantAnonymous) :?>
					<div class="merchantAnonymous">
						<strong><?php echo  JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANT_ANONYMOUS') ?></strong>
						&nbsp;
						<span><a  href="javascript:void(0);" onclick="getData(urlCheck,'merchantid=<?php echo $merchant->MerchantId?>&task=GetPhoneByMerchantId&language=' + cultureCode,this)"  id="phone<?php echo $resource->ResourceId?>"><?php echo  JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANTS_VIEW_MERCHANTDETAILS_SHOWPHONE') ?></a></span>
						&nbsp;
						<span><a  href="javascript:void(0);" onclick="getData(urlCheck,'merchantid=<?php echo $merchant->MerchantId?>&task=GetPhoneByMerchantId&n=1&language=' + cultureCode,this)"  id="phone<?php echo $resource->ResourceId?>"><?php echo  JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANTS_VIEW_MERCHANTDETAILS_SHOWPHONE1') ?></a></span>
					</div>
				<?php else: ?>
					...
					<?php endif ?>
					<h3 class="mod_bookingforconnector_merchantdetails-menuTitle"><a href="<?php echo $routeMerchant?>" class="item"><span class="com_bookingforconnector_merchantdetails-merchant-name"><?php echo $merchant->Name?></span></a>
						<span class="com_bookingforconnector_merchantdetails-rating com_bookingforconnector_merchantdetails-rating<?php echo  $merchant->Rating ?>">
							<span class="com_bookingforconnector_merchantdetails-ratingText">
					...
					<div class="com_bookingforconnector_merchantdetails-merchant-address"><span class="street-address"><?php echo $indirizzo ?></span>, <span class="postal-code "><?php echo  $cap ?></span> <span class="locality"><?php echo $comune ?></span> <span class="region">(<?php echo  $provincia ?>)</span></div><br />
					<span><a  href="javascript:void(0);" onclick="getData(urlCheck,'merchantid=<?php echo $merchant->MerchantId?>&task=GetPhoneByMerchantId&language=' + cultureCode,this)"  id="phone<?php echo $resource->ResourceId?>"><?php echo  JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANTS_VIEW_MERCHANTDETAILS_SHOWPHONE') ?></a></span>
					<!-- &nbsp;
					<span><a  href="javascript:void(0);" onclick="getData(urlCheck,'merchantid=<?php echo $merchant->MerchantId?>&task=GetPhoneByMerchantId&n=1&language=' + cultureCode,this)"  id="phone<?php echo $resource->ResourceId?>"><?php echo  JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANTS_VIEW_MERCHANTDETAILS_SHOWPHONE1') ?></a></span> -->
				<?php endif ?>
...
<?php endif; ?>
		...
		function openGoogleMapResource() {
			if (typeof google !== 'object' || typeof google.maps !== 'object'){
				...
				script.type = "text/javascript";
				script.src = "https://maps.google.com/maps/api/js?key=<?php echo $googlemapsapykey ?>&libraries=drawing&sensor=false&callback=handleApiReady";
