...
<div class="royalSlider rsUni" id="resourcePlanimetrygallery">
	...
	<a class="rsImg" href="<?php echo BFCHelper::getImageUrl('onsellunits', $image)?>"><img class="rsTmb" src="<?php echo BFCHelper::getImageUrl('onsellunits', $image, 'onsellunit_gallery_thumb')?>"></a>		
	<?php endforeach?>
</div>
