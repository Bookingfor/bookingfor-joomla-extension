	...
	<div class="com_bookingforconnector_search-resource">
		<div class="com_bookingforconnector_merchantdetails-resource com_bookingforconnector_merchantdetails-resource-t<?php echo $resource->MasterTypologyId?>">
			<div class="com_bookingforconnector_merchantdetails-resource-features">
				...
				<a class="com_bookingforconnector_merchantdetails-resource-moreinfo" href="javascript:void(0);" onclick="toggleDetails(this,'com_bookingforconnector-merchantlist-merchant-open','div.com_bookingforconnector_merchantdetails-resource-features');"><?php echo JTEXT::_('COM_BOOKINGFORCONNECTOR_MERCHANTS_VIEW_MERCHANTDETAILS_RESOURCE_LINK')?></a>
			</div>
			...
			<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?> com_bookingforconnector_search-merchant-resource nominheight noborder">
					<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_ROW ?> ">
						<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>3 com_bookingforconnector_merchantdetails-resource-paxes minheight34 borderright">
						...
						<div class="<?php echo COM_BOOKINGFORCONNECTOR_BOOTSTRAP_COL ?>3 com_bookingforconnector_merchantdetails-resource-rooms minheight34 ">
							<?php if ($unit != null):?>
