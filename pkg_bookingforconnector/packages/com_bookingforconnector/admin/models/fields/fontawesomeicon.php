 ...
 * 
 */
class JFormFieldFontAwesomeIcon extends JFormFieldText
{
	...
	public function getInput() {
		...
		JHTML::stylesheet('components/com_bookingforconnector/assets/js/iconpicker/icon-picker.css');
		JHTML::script('components/com_bookingforconnector/assets/js/iconpicker/icon-picker.js');
		$output = '<div id="div_'.$this->id.'" class="jicon-picker" data-pickerid="fa" data-iconsets=\'{"fa":"Pick FontAwesome"}\' style="width: 100%;">
		<input type="text" id="'.$this->id.'" name="'.$this->name.'" value="'.$this->value.'"></div>';
		$output .= "<script type='text/javascript'> jQuery(document).ready(function(){jQuery('#div_".$this->id."').qlIconPicker({'save': 'class','mode': 'dialog'});});</script>";
$output .= '<div class="fa-set jicon-set">
	<ul>
		<li data-code="f236" data-class="fa fa-bed" class="fa fa-bed"></li>
