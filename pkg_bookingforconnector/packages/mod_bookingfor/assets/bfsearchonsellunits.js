//function hideSaleRent(elementId){
//  if(elementId=='0'){
//    jQuery(".hideRent").show();
//    jQuery(".hideSale").hide();
//  }else{
//    jQuery(".hideSale").show();
//    jQuery(".hideRent").hide(); 
//  }
//}
//
//jQuery(document).ready(function(){
// hideSaleRent(jQuery("#contractTypeId").val()); 
// jQuery("#contractTypeId").on('change',function(){
//  hideSaleRent(jQuery(this).val());
//});
//});
...
//		}
		function openGoogleMapBFSSell() {
			...
			$dialog.dialog('open');
			jQuery("#map_canvasBFSSell").css("height", height-150);
